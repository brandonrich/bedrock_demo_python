...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate conversation using Anthropic Claude model.")
    parser.add_argument("--model-id", default="anthropic.claude-3-sonnet-20240229-v1:0",
                        help="Model ID to use for the conversation (default: %(default)s)")
